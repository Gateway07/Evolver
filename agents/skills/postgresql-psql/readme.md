...
A comprehensive Skill for AI Agent providing complete reference documentation for PostgreSQL's psql command-line client.
...
- **guide.md** (1,336 lines): Complete reference documentation
...
This skill is designed for AI Agent users to:
...
```
./skills/postgresql-psql/
```

If using AI Agent's skill system, it will be automatically available.
...
**Start using this skill in AI Agent by asking PostgreSQL-related questions!**
